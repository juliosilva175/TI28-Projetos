...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "SELECT COUNT(usu_id) FROM tb_clientes
    WHERE cli_nome = '$nome' OR cli_cpf = '$cpf' OR cli_email = '$email' OR cli_telefone = '$telefone'";
    // RETORNO DO BANCO
    ...
    if($contagem == 0){
        $sql = "INSERT INTO tb_clientes(cli_nome, cli_cpf, cli_email, cli_celular cli_status)
        VALUES ('$nome', '$cpf', '$email', '$celular '1')";
